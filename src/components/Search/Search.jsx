...
function Search() {
    return (
        <div className="w-[1100px] h-[60px] bg-white rounded-[100px] flex flex-row justify-center items-center gap-x-10">
            ...
            <input type="text" placeholder="Vị trí tuyển dụng & tên công ty" className="w-[330px] h-[50px] focus:outline-0" />
            ...
            justify-between text-[white] bg-[#5DDA33] hover:bg-[#33da6d] hover:text-[white] transition-all ease-in ">Tìm kiếm</button>
        </div>
    )
};
