...
export default function ColorPicker() {
  ...
  return (
    <div className="p-4 max-w-md mx-auto bg-white rounded-lg shadow">
        ...
        <div className="w-full">
          <div className="flex items-center mb-3">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-7 pr-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-green-500"
              />
            </div>
          </div>
          ...
          <div className="flex items-center mb-3">
            ...
            <input
              ...
              className="flex-1 px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-green-500"
            />
          </div>
      ...
      <button className="w-full px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50">
        Cập nhật
      </button>
    </div>
  );
