...
import TextAreaForm from '../../pages/JobPosting/TextAreaForm';
import { DatePicker } from 'antd';
import useCustomMutation from '../../hooks/useCustomMutation';
import { postRecruitmentNewsApi, getJobByIdApi } from '../../services/recruiterApi';
...
const EditJob = () => {
                ...
                try {
                    ...
                    if (jobData) {
                        setFormData({
                            ...
                            candidateNumber: jobData.candidateNumber || '',
                            ...
                            salary: {
                                ...
                                negotiable: jobData.salaryNegotiable || false,
                            },
                        ...
                        // Set province and district if available
                        if (jobData.province) {
                            setSelectedProvince({ label: jobData.province, value: jobData.province });
                        }
                        if (jobData.district) {
                            setSelectedDistrict({ label: jobData.district, value: jobData.district });
                        }
                    }
                } catch (error) {
                    ...
                    setNotification({
                        type: 'error',
                        message: 'Không thể tải thông tin tin tuyển dụng'
                    });
                }
            }
        };
    ...
    const handleSubmit = async (e) => {
        ...
        await withLoading(async () => {
            ...
            setNotification({
                type: 'success',
                message: id ? 'Cập nhật tin tuyển dụng thành công' : 'Tạo tin tuyển dụng thành công'
            });
        });
    };
    ...
    const handlePreview = () => {
      // Có thể thêm bước validate form ở đây nếu muốn
      // const validationError = validateForm();
      // if (validationError) {
      //     window.alert(validationError);
      //     return;
    ...
    const renderPreviewModal = () => {
      ...
      return (
        <div
          className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-[100]" // Tăng z-index nếu cần
          onClick={() => setShowPreview(false)} // Đóng khi click nền
        >
          <div
           className="bg-white rounded-lg shadow-xl w-[95vw] h-[95vh] flex flex-col"
          ...
          >
            ...
            {/* Truyền dữ liệu hiện tại của form vào PreviewNews */}
            <div className="flex-grow overflow-hidden">
              {" "}
              {/* Thêm p-1 để tránh scrollbar bị che */}
              <PreviewNews
                formDataForPreview={formData}
                selectedProvinceForPreview={selectedProvince}
                selectedDistrictForPreview={selectedDistrict}
                videoFileForPreview={videoFile}
                isPreviewMode={true} // Đánh dấu đây là chế độ xem trước
              />
            </div>
            <div className="p-4 border-t text-right">
              <button
                type="button"
                className="bg-gray-200 text-gray-700 font-medium py-2 px-6 rounded-md hover:bg-gray-300 transition-colors"
                onClick={() => setShowPreview(false)}
              >
                Đóng
              </button>
    ...
    return (
      <div className="job-posting-form pb-10">
        ...
        >
          <h1 className="text-2xl font-bold mb-6">Chỉnh sửa tin tuyển dụng</h1>
          {notification && (
            <div
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div className="form-group">
                ...
                >
                  ...
                  <option value="Giám đốc / Phó giám đốc">
          ...
          <div className="form-section mb-8">
            ...
            <div className="form-group mb-4">
              ...
              <TextAreaForm
                ...
                onChange={(value) =>
                  handleRichTextChange("jobRequirements", value)
                }
          ...
          <div className="form-section">
            ...
            <div className="form-group mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  handleNestedInputChange("contactInfo", "name", e.target.value)
                }
                required
              />
            </div>
            ...
            <div className="mt-6 flex gap-4">
              ...
              <button
                type="button"
                className="bg-green-500 text-white font-medium py-2 px-8 rounded-md hover:bg-green-600 transition-colors"
